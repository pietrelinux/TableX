...
sleep 1
apt-get update
apt-get install -y flex bison gcc-arm-linux-gnueabihf wget bc tree git debootstrap qemu-user-static build-essential libssl-dev libusb-1.0-0-dev bin86 libqt4-dev libncurses5 libncurses5-dev qt4-dev-tools u-boot-tools device-tree-compiler swig libpython-dev libqt4-dev libusb-dev zlib1g-dev pkg-config 
...
sleep 1
dd if=/dev/zero of=/mnt/ramdisk/sunxi/Imagen/xenial.img bs=1 count=0 seek=2700M
mkfs.ext4 -b 4096 -F /mnt/ramdisk/sunxi/Imagen/xenial.img
chmod 777 /mnt/ramdisk/sunxi/Imagen/xenial.img
mkdir /TableX
mount -o loop /mnt/ramdisk/sunxi/Imagen/xenial.img /TableX
...
sleep 1
wget -P /mnt/ramdisk/sunxi/kernel/mainline https://cdn.kernel.org/pub/linux/kernel/v4.x/linux-4.16.3.tar.xz
cd /mnt/ramdisk/sunxi/kernel/mainline/
tar -Jxf /mnt/ramdisk/sunxi/kernel/mainline/linux-4.16.3.tar.xz
cp /mnt/ramdisk/sunxi/TableX_defconfig /mnt/ramdisk/sunxi/kernel/mainline/linux-4.16.3/arch/arm/configs/
cd /mnt/ramdisk/sunxi/kernel/mainline/linux-4.16.3
...
ARCH=arm CROSS_COMPILE=arm-linux-gnueabihf- INSTALL_MOD_PATH=/home/sunxi/kernel/modules make modules modules_install
cp -R /home/sunxi/kernel/modules/lib/ /TableX/
...
umount /TableX
sudo cp /mnt/ramdisk/sunxi/Imagen/xenial.img /home/sunxi/xenial.img 
exit
