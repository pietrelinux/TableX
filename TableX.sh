...
sleep 1
dd if=/dev/zero of=/mnt/ramdisk/sunxi/Imagen/bionic.img bs=1 count=0 seek=3000M
...
umount /TableX
sudo cp -R /mnt/ramdisk/sunxi/Imagen/bionic.img /home/sunxi/Imagen/bionic.img 
exit
