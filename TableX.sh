...
sleep 1
apt-get update
apt-get install -y flex bison gcc-arm-linux-gnueabihf wget bc tree git build-essential libssl-dev libusb-1.0-0-dev bin86 libqt4-dev libncurses5 libncurses5-dev qt4-dev-tools u-boot-tools device-tree-compiler swig libpython-dev libqt4-dev libusb-dev zlib1g-dev pkg-config libgtk2.0-dev libglib2.0-dev libglade2-dev
...
sleep 1
wget -P /home/sunxi/kernel https://cdn.kernel.org/pub/linux/kernel/v5.x/linux-5.2.14.tar.xz
cd /home/sunxi/kernel
tar -Jxf /home/sunxi/kernel/linux-5.2.14.tar.xz
cp /home/sunxi/TableX_defconfig /home/sunxi/kernel/linux-5.2.14/arch/arm/configs/
cd /home/sunxi/kernel/linux-5.2.14
echo " Compilando "
