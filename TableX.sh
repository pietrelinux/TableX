...
sleep 1
dd if=/dev/zero of=/mnt/ramdisk/sunxi/Imagen/precise.img bs=1 count=0 seek=2700M
mkfs.ext4 -b 4096 -F /mnt/ramdisk/sunxi/Imagen/precise.img
chmod 777 /mnt/ramdisk/sunxi/Imagen/precise.img
mkdir /TableX
mount -o loop /mnt/ramdisk/sunxi/Imagen/precise.img /TableX
debootstrap --arch=armhf --foreign precise /TableX
...
umount /TableX
sudo cp /mnt/ramdisk/sunxi/Imagen/precise.img /home/sunxi/precise.img 
exit
